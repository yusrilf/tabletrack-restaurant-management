        ...
        @if (in_array('Customer Display', restaurant_modules()))
          <div class="relative flex items-center">
              <button id="customer-display-dropdown-button" type="button"
                  ...
                  aria-expanded="false" aria-haspopup="true" data-dropdown-toggle="customer-display-dropdown-menu" data-tooltip-target="customer-display-tooltip-toggle">
                  ...
                  <ul class="py-1" role="menu" aria-orientation="vertical" aria-labelledby="customer-display-dropdown-button">
                      <li>
                          <a href="/customer-display" target="_blank" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" role="menuitem">
                              <svg xmlns="http://www.w3.org/2000/svg" class="inline w-4 h-4 mr-2 text-skin-base" fill="none" stroke="currentColor" stroke-width="2" width="24" height="24" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-monitor w-5 h-5 md:w-5 md:h-5 sm:w-6 sm:h-6"><rect width="20" height="14" x="2" y="3" rx="2"/><path d="M8 21h8m-4-4v4"/></svg>
                              Customer Display
                          </a>
                      </li>
              ...
              <div id="customer-display-tooltip-toggle" role="tooltip"
              class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip">
              Customer Display
              <div class="tooltip-arrow" data-popper-arrow></div>
            </div>
